...
public class DialogueAudio : MonoBehaviour
{
    ...
    void Start()
    {
        villager = GetComponent<NPCScript>();

        animatedText = UIDialogueManager.instance.animatedText;
    ...
    public void ReproduceSound(char c)
    {
        ...
        if (villager != UIDialogueManager.instance.currentNPC)
            return;
